    ...
    <div className="min-h-screen bg-gray-50 relative">
      ...
      {successData && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[100] p-4 animate-[fadeIn_0.2s_ease-out]">
          <div className="bg-white border border-gray-200 p-8 rounded-2xl max-w-sm w-full text-center shadow-2xl transform scale-100 transition-all">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Phone Updated!</h3>
            <p className="text-gray-600 mb-6">
              Contact number for <span className="text-gray-900 font-mono font-bold">{successData.ref}</span> changed to <span className="text-yellow-600 font-bold">{successData.phone}</span>.
            </p>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                onClick={resetForm}
                className="px-4 py-2 bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-medium rounded-lg shadow-lg transition-all cursor-pointer"
              >
                Next Update
              </button>
            </div>
      ...
      <main className="max-w-4xl w-full h-full mx-auto px-2 md:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
          ...
          {/* Page Header Banner */}
          <div className="bg-amber-500 px-3 py-6">
          ...
          <div className="px-6 pt-6">
            {error && (
              <div className="mb-2 p-4 bg-red-50 border border-red-200 rounded-lg text-red-700 text-sm animate-shake">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex items-end">
                  <button
                    ...
                    disabled={loading || isFetched}
                    className="h-[46px] px-6 bg-amber-500 hover:bg-amber-600 text-white font-semibold rounded-lg shadow-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                  >
                    {loading ? (
            ...
            {isFetched && (
              <div className="space-y-6 pt-6 border-t border-gray-200 animate-fade-in">
                <h3 className={labelStyles.replace('mb-2', '') + " text-lg font-semibold text-gray-900 flex items-center"}>
                  <svg className="w-5 h-5 mr-2 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                  Update Details
                </h3>
                ...
                <div>
                  <label className={labelStyles}>New Phone Number <span className="text-red-500">*</span></label>
                  <input
                    type="tel"
                    value={newPhone}
